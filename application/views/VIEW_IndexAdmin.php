    ...
    <div class="span12">
      <div class="row-fluid">
        <div class="span12">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php echo anchor('CTR_Index/HapusData/'.$row->Username,"<button type='button' class='btn btn-danger' data-placement='top' data-toggle='tooltip' title='Hapus'><span class='icon-trash'></span></button>",array('onclick'=>"return confirm('Hapus data $row->Password ?');")); ?>
                </td>
                </td>
              </tr>
              <?php } ?> 
          ...
          <div class="well">
            <a button class="btn btn-block btn-success" type="button" href="<?php echo site_url('CTR_Index/AddForm')?>" role="button"><i class="icon-edit icon-large"></i> Add Admin</button></a>
          </div>
        </div>
      </div>
    </div> 
