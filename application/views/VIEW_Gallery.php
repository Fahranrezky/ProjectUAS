...
<body>
    ...
    <div class="container">
            ...
            <div class="navbar-inner">
                <a class="brand" href="#"></a>
                    <ul class="nav">
                        ...
                        <li>
                            <a href="<?php echo site_url('CTR_Product/index')?>"><i class="icon-th-list icon-large"></i> Character
                            </a>
                        </li>
                        <li class="active">
                            <a href="#"><i class="icon-picture icon-large"></i> Gallery</a>
                        </li>
      ...
      <!-- Example row of columns -->
        <div class="row">
            <div class="span9">
                <div class="latest"><i class="icon-picture icon-large"></i> Our Characters Original and New Robbers</div>
                        <?php
                        $dbhost = 'localhost';
                        $dbuser = 'root';
                        $dbpass = '';
                        ...
                        $query=mysqli_query($connection,"select * from tbl_gallery ORDER by Photo_ID DESC")or die(mysql_error());
                        foreach ($daftar_gal as $row) 
                        while($row=mysqli_fetch_array($query)){
                        $id=$row['Photo_ID'];
                        ?>     
                        <div class="gallery"> <a href="../../gambar/<?php echo $row['Photo']; ?>">
