        ...
        <div class="row">
            <div class="span9">
                <div class="latest"><i class="icon-phone icon-large"></i> Contact Us</div>
                    <br>
                    <p> Your comments and suggestions are important to us and we invite you to share them below.
                    We will respond to your message as quickly as we can.</p><br><br>
                    <form method="post" action="<?php echo site_url('CTR_Contact/SimpanContact'); ?>">
